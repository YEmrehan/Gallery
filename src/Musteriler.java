...
public class Musteriler extends javax.swing.JFrame {
    ...
    private void btn_duzenleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_duzenleActionPerformed
        ESD duzenle = new ESD();
        duzenle.musteriDuzenle(jTable1, tf_id, tf_isim, tf_soyisim, tf_telefon, ta_adres);
    ...
    private void btn_ekleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_ekleActionPerformed
        ESD ekle = new ESD();
        ekle.musteriEkle(jTable1, tf_id, tf_isim, tf_soyisim, tf_telefon, ta_adres);
